...
def execute_script(params)
  ...
  Logger.log("Reserving an IP address in AO ...")
  ip_address = ao_reserve_ip_address(host_name)

  Logger.log("Adding the IP address to the request-level parameters ...")
  ...
  Logger.log("Showing the IP address in the output field ...")

...
# custom settings
export EVENT_HANDLER_BRPM_PORT=29418
...
jruby $BRPM_HOME/releases/$VERSION/RPM/lib/script_support/git_repos/brpm_dev_automation_scripts/integrations/event_handler.rb
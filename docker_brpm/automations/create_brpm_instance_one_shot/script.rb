...
def execute_script(params)
  ...
  Logger.log "Creating a BRPM instance named '#{instance_name}' on port #{port} (docker host = #{docker_host_name})..."
  Logger.log ""
  Logger.log ""
  ...
  Logger.log "Creating the installed component for Utilities ..."
  ...
  Logger.log "Creating the installed component for Database ..."
  ...
  Logger.log "Finished"
  Logger.log ""
  Logger.log "You can now access the newly created instance on http://#{docker_host_name}:#{port}/brpm"
  Logger.log ""
  Logger.log ""
